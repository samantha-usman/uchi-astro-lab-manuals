...
\begin{minipage}{0.45\textwidth}
\emph{Question:}
What do you see through the grating? How do you think this would change if you were viewing different light sources such as: a neon sign? Light from the sun? A street lamp?
\end{minipage}}
\hspace{0.3cm}
\vspace{0.2cm}
\begin{minipage}{0.5\textwidth}
...
Choose 5 different voltages you'd like to use for the adjustable lamp.  Set
